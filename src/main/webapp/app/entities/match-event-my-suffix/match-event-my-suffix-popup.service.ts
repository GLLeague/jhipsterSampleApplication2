...
@Injectable()
export class MatchEventMySuffixPopupService {
            ...
            if (id) {
                this.matchEventService.find(id)
                    .subscribe((matchEventResponse: HttpResponse<MatchEventMySuffix>) => {
                        const matchEvent: MatchEventMySuffix = matchEventResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.matchEventModalRef(component, new MatchEventMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    matchEventModalRef(component: Component, matchEvent: MatchEventMySuffix): NgbModalRef {
