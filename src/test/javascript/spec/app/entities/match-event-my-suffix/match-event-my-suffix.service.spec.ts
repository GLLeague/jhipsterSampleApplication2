...
describe('Service Tests', () => {
    ...
    describe('MatchEventMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MatchEventMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/match-events';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return MatchEventMySuffix', () => {
